            ...
            <el-row>
              ...
              <el-col :span="22">
                <el-tabs v-model="tabPosition" @tab-click="handleClick" ref="danxuanti">
                  <el-tab-pane label="单选题" class="questionType" name="单选题">
                  ...
                  <el-tab-pane label="单选组合" name="单选组合">
                    <el-row class="questionRow" style="margin-bottom:15px;">
                      <el-col :span="2">
                  ...
                  <el-tab-pane label="填空组合" name="填空组合">
                    <!-- 文本 -->
                    <el-row class="questionRow">
                      <el-col :span="2">
                        <span class="outSpan">短文:</span>
                  ...
                  <el-tab-pane label="作文题" name="作文题">
                    <el-row class="questionRow">
                      <el-col :span="2">
                        <span class="outSpan">题干:</span>
                      </el-col>
  ...
  methods: {
    ...
    handleClick(tab, event) {
      ...
      if (tab.label == "填空题") {
        ...
        single = "1";
        type = "书面表达";
      } else if (tab.label == "填空组合") {
        multiple = "1";
        single = "1";
        type = "综合阅读";
      } else if (tab.label == "作文题") {
        multiple = "0";
        single = "2";
        type = "书面表达";
      } else if (tab.label == "单选题") {
        multiple = "0";
        single = "0";
        type = that.type2;
      } else if (tab.label == "单选组合") {
        multiple = "1";
        single = "0";
        type = that.type2;
      }
          ...
          if (quePart1 != "" && quePart2 != "") {
            ...
            if (String(setCorrect) != "") {
              ...
              if (that.shortEssayTxt2 != "" || that.type2 != "综合阅读") {
                ...
                this.$axios
                  .post(Question.questionmultiple, {
                    DifficultyType: diffType,
                    Level1: point1,
                    Level2: point2,
                    Level3: point3,
            ...
            if (count1 == this.listForFC.length) {
              if (count2 == this.listForFC.length) {
                if (quePart1 != "" && quePart2 != "") {
                  ...
                  this.$axios
                    .post(Question.questioncompletionmultiple, {
                      DifficultyType: that.value4,
                      Level1: point1,
                      Level2: point2,
                      Level3: point3,
                      Context: context,
    ...
    getKnowledgePoint2(listForKP, selVal, index) {
      ...
      if (!selVal != "请选择") {
        ...
        // 第二个知识点
        this.$axios
          .post(Question.knowledgepointlevel2, {
            Level1: selVal,
          })
          .then(function (response) {
            // console.log(response);
            console.log("知识点2", response);
            var ballList2 = [];
            for (var i = 0; i < response.data.data.length; i++) {
              ballList2.push({
                value: response.data.data[i].KnowledgeId,
    ...
    getKnowledgePoint3(listForKP, selVal, index) {
      ...
      if (!selVal != "请选择") {
        ...
        // 第三个知识点
        this.$axios
          .post(Question.knowledgepointlevel3, {
            Level2: selVal,
          })
          .then(function (response) {
            console.log("知识点3", response);
            var ballList3 = [];
            for (var i = 0; i < response.data.data.length; i++) {
              ballList3.push({
                value: response.data.data[i].KnowledgeId,
